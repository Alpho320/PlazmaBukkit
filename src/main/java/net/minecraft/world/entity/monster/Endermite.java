...
public class Endermite extends Monster {
    ...
    public static boolean checkEndermiteSpawnRules(EntityType<Endermite> type, LevelAccessor world, MobSpawnType spawnReason, BlockPos pos, RandomSource randomSource) {
        if (checkAnyLightMonsterSpawnRules(type, world, spawnReason, pos, randomSource)) {

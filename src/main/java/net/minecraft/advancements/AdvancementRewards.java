...
public class AdvancementRewards {
    ...
    public void grant(ServerPlayer player) {
        ...
        this.function.get(minecraftServer.getFunctions()).ifPresent((function) -> {
            minecraftServer.getFunctions().execute(function, player.createCommandSourceStack().withSuppressedOutput().withPermission(2));
        });
    }
